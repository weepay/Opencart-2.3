...
class ControllerExtensionPaymentWeepayPayment extends Controller
{
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('weepay_payment', $this->request->post);
        ...
        if (isset($this->request->get['update_error'])) {
            ...
            if (!empty($versionCheck['version_status']) and $versionCheck['version_status'] == '1') {
                ...
                $data['version_update_link'] = $this->url->link('extension/payment/weepay_payment/update', 'token=' . $this->session->data['token'] . "&version=$version_updatable", true);
            }
        }
        ...
        $data['action'] = $this->url->link('extension/payment/weepay_payment', 'token=' . $this->session->data['token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/payment/weepay_payment.tpl', $data));
    }
    ...
    public function update()
    {
        ...
        if ($updated == 1) {
            ...
            $this->response->redirect($this->url->link('extension/payment/weepay_payment', 'token=' . $this->session->data['token'] . "&update_error=$updated", true));
        }
    }
    ...
    public function order()
    {
        ...
        return $this->load->view('extension/payment/weepay_order.tpl', $data);
    }
